...
/**
 * Pengelola database SQLite untuk data akuarium.
 */
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        private const val COLUMN_REF_TANK_ID = "tank_id"
    ...
    /**
     * Mengaktifkan fitur foreign key pada database.
     */
    ...
    /**
     * Membuat tabel tanks dan tank_logs saat pertama kali dibuat.
     */
    ...
    /**
     * Mengambil waktu saat ini dalam format string.
     */
    ...
    /**
     * Memasukkan data log baru dan membuat tangki jika baru.
     */
    ...
    /**
     * Mengambil log terakhir dari setiap tangki yang ada.
     */
    ...
    /**
     * Mengambil riwayat log untuk tangki tertentu.
     */
    ...
    /**
     * Menghapus data tangki dan semua riwayat lognya.
     */
